...
#10.birth_monthが空では登録できないこと
    it "is invalid without a birth_monthr" do
...
#9.phone_numberが空では登録できないこと
    it "is invalid without a phone_number" do
      expect(FactoryBot.build(:user, phone_number: "")).to_not be_valid 
    end
